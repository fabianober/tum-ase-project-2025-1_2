...
def run_get_properties(name):
    ...
    panelPropertiesdf.to_csv(f'data/{name}/properties/panel_properties.csv')
    ...
    massDf.to_csv(f'data/{name}/properties/element_masses.csv')
